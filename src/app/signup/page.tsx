  ...
  if (done) {
    return (
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="glass-elevated p-10 max-w-sm w-full text-center">
          <CheckCircle2 className="w-12 h-12 text-emerald-400 mx-auto mb-4" />
          <h2 className="text-xl font-bold text-[var(--text-primary)] mb-2">Check your email</h2>
          <p className="text-sm text-[var(--text-muted)]">
            We sent a confirmation link to <strong className="text-[var(--text-secondary)]">{email}</strong>.
    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="glass-elevated p-8">
          ...
          <p className="text-sm text-[var(--text-muted)] mb-6">Free — 30 rewrites included, no card needed</p>

          <button
            onClick={handleGoogleSignup}
            className="w-full glass glass-hover flex items-center justify-center gap-3 py-2.5 rounded-xl text-sm font-medium text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-colors mb-4"
          >
